...
areaPintada = float(input("Digite o tamanha da áera a ser pintada em metros quadrados: "))

if(areaPintada <= 21.60):
    print("Comprar apenas galões de 3,6 litros")
elif(areaPintada > 21.60):
    print("Comprar apenas galões de 18 litros")
